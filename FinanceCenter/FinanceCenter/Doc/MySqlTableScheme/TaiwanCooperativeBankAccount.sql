-- ============================================
-- 合作金庫帳戶明細資料表 (Taiwan Cooperative Bank Account)
-- 建立日期: 2026-01-07
-- ============================================

CREATE TABLE IF NOT EXISTS `TaiwanCooperativeBankAccount` (
    ...
    PRIMARY KEY (`Id`),
    INDEX `idx_tcb_createday` (`CreateDay`),
    INDEX `idx_tcb_department` (`Department`),
    INDEX `idx_tcb_applicant` (`Applicant`)
) ENGINE=InnoDB
